...
export default interface IContract {
     ...
     */
    createBooking(reservationDetails: IReservationDetail[], creditCardNumber:number, frequentFlyerNumber?: number): IBookingDetail | InconsistentLengthError | NotFoundError | InvalidInputError
